    ...
    >
        <div className=" bg-transparent bg-black bg-opacity-10 p-4 rounded-md flex-col md:w-1/2 w-3/4   text-white flex transition duration-200 justify-center ">
          ...
          <div className="flex gap-8 mt-10">
             ...
             <span className="flex bg-white border-1 rounded-md p-2 text-black font-fredoka font-light border-black justify-center items-center"><img className="h-6 rounded-full" src="https://upload.wikimedia.org/wikipedia/commons/1/19/LeetCode_logo_black.png"/><p>Leetcode<p/> </span>
