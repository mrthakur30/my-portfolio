...
function App() {
  return (
    ...
    >
        <div className=" bg-transparent bg-black bg-opacity-10 p-4 rounded-md flex-col md:w-1/2 w-3/4   text-white flex transition duration-200 justify-center ">
          ...
          transition={{
           ...
           className=" md:text-5xl text-3xl font-fredoka font-semibold text-transparent tracking-widest transition  bg-clip-text  bg-gradient-to-l  from-orange-400 to-indigo-200">{"Hi, I'm Mukul Thakur"}</motion.p>
          <motion.p
           initial={{ x: -700, opacity: 0 }}
           animate={{ x: 0, opacity: 1 }}
           exit={{ x: -700, opacity: 0 }}
           ...
           className=" md:text-7xl text-4xl font-fredoka font-semibold text-transparent tracking-wider bg-clip-text bg-gradient-to-r  from-pink-400 to-green-200">Frontend Developer</motion.p>
